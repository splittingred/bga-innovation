 ...
 * -----
 * 
 * innovationsplittingred.action.php
 *
 ...
 * this.ajaxcall( "/innovationsplittingred/innovationsplittingred/myAction.html", ...)
 *
 */
  
  
  class action_innovationsplittingred extends APP_GameAction {
    ...
    public function __default() {
        if(self::isArg('notifwindow')) {
            ...
            $this->view = "innovationsplittingred_innovationsplittingred";
