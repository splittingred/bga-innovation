...
class Innovation extends Table
{
    ...
    private \Innovation\GameState $innState;
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->innState = new \Innovation\GameState($this);
    ...
    function upgradeTableDb($from_version) {
        ...
        if ($this->innState->get('release_version') == 0) {
            self::initGameStateLabels(array(
                'card_id_1' => 69,
                'card_id_2' => 70,
                'card_id_3' => 71,
    ...
    */
    protected function setupNewGame($players, $options = array())
    {
        ...
        $this->innState->set('debug_mode', $this->getBgaEnvironment() == 'studio' ? 1 : 0);
